...
use crate::ritmo_db::migration::Migrator;
use crate::ritmo_db::verify_path::verify_path;
...
async fn seed_languages_names_table(conn: &DatabaseConnection) -> Result<(), DbErr> {
    ...
    let mut iso_table : Vec<crate::ritmo_db::entities::languages_names::ActiveModel> = Vec::new();

    for (iso_code, language_name) in languages {
        let iso_single: crate::ritmo_db::entities::languages_names::ActiveModel = crate::ritmo_db::entities::languages_names::ActiveModel {
