...
//
//        let tag_id = tags_result.id.ok_or(RitmoErr::DatabaseInsertFailed(format!("Tag not found or added")))?;
//
//        query!(
...
use crate::db::adds::search_and_add::*;
use crate::RitmoErr;
use sqlx::{query, SqlitePool, Transaction};
