...
fn test_apply_negative_feedback() {
    ...
    let mut records = vec![
        TestRecord {
            id: 1,
            canonical: "pippo".into(),
            variants: vec!["pippo".into(), "pluto".into()],
        },
        TestRecord {
            id: 2,
            canonical: "pluto".into(),
            variants: vec!["pluto".into(), "pippo".into()],
        },
    ];
...
fn test_apply_positive_feedback() {
    ...
    let mut records = vec![
        TestRecord {
            id: 1,
            canonical: "pippo".into(),
            variants: vec!["pippo".into()],
        },
        TestRecord {
            id: 2,
            canonical: "pluto".into(),
            variants: vec!["pluto".into()],
        },
    ];
    ...
    assert_eq!(
        records[0].variants,
        vec!["pippo".to_string(), "pluto".to_string()]
    );
    assert_eq!(
        records[1].variants,
        vec!["pippo".to_string(), "pluto".to_string()]
...
fn test_feedback_combined() {
    ...
    let mut records = vec![
        ...
        TestRecord {
            id: 3,
            canonical: "paperino".into(),
            variants: vec!["paperino".into(), "pluto".into()],
        },
    ];
