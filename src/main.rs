        ...
        Commands::ContentAdd { path, .. } => {
            ...
            let mut content = Content {
                data: ContentUserData {
                    ...
                    lang: vec![
                        ("Italian".to_string(), "current".to_string()),
                        ("Russian".to_string(), "original".to_string()),
                    ],
                    people: vec![("unknown".to_string(), "Author".to_string())],
        ...
        Commands::BookAdd { path, .. } => {
            ...
            let content = Content {
                data: ContentUserData {
                    ...
                    lang: vec![
                        ("Italian".to_string(), "current".to_string()),
                        ("Croatian".to_string(), "original".to_string()),
                    ],
                    people: vec![
            ...
            let content = Content {
                data: ContentUserData {
                    ...
                    lang: vec![
                        ("Italian".to_string(), "current".to_string()),
                        ("Swedish".to_string(), "original".to_string()),
                    ],
                    people: vec![
                    ...
                    tags: vec![
                        "doppia stronzata".to_string(),
                        "altra stronzata".to_string(),
                    ],
                    ..Default::default()
                },
                ..Default::default()
